...
import { PrivacyOption } from "@/services/userService";
...
type AccountPrivacySheetProps = {
  current: PrivacyOption;
...
export default function AccountPrivacySheet({
  current,
  onSelect,
  onClose,
}: AccountPrivacySheetProps) {
  return (
          ...
          {PRIVACY_OPTIONS.map((option) => (
            ...
            >
              <View style={styles.optionContent}>
                <MaterialIcons name={option.icon} size={24} color="#333" />
